...
func (m *PythonSdkRuntime) getImage(name string) Image {
...
func (d *Discovery) Load(ctx context.Context, m *PythonSdkRuntime) error {
	type loadFunc func(context.Context, *PythonSdkRuntime) error
...
func (d *Discovery) loadModInfo(ctx context.Context, m *PythonSdkRuntime) error {
...
func (d *Discovery) loadFiles(ctx context.Context, m *PythonSdkRuntime) error {
